...
public class Algorithms {
    ...
    public static LinkedList<Point> findCircuit(Graph<Point, Border> g, LinkedList<Point> path) {
        LinkedList<Point> list = new LinkedList<>(path);
        while (list.size() > 2) {
    ...
    public static void nearestLocationSearch(Graph<Point, Border> graph, Point orig, boolean[] visited, LinkedList<Point> list) {
        ...
        for (Point adj : graph.adjVertices(orig)) {
    ...
    public static ArrayList<LinkedList<Point>> findBiggestCircuit(ArrayList<LinkedList<Point>> circuit) {
        ArrayList<LinkedList<Point>> result = new ArrayList<>();
        int sizemax = 0;
        for (LinkedList<Point> list : circuit) {
