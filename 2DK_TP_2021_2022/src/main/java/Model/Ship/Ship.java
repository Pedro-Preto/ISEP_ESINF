...
import Utils.CountingAlgorithms;
...
public class Ship {
    ...
    public String toString() {
        return String.format("mMSI:%d ,baseDateTime:%s ,lAT:%s ,lON:%s ,sOG:%s ,cOG:%s ,heading:%d ,vesselName:%s ,iMO:%s ,callSign:%s ,vesselType:%d ,length:%d ,width:%d ,draft:%s ,cargo:%d ,transcieverClass:%s ,vehicleID:%s",
                                mMSI,baseDateTime,lAT,lON,sOG,cOG,heading,vesselName,iMO,callSign,vesselType,length,width,draft,cargo,transcieverClass,vehicleID);
    }
