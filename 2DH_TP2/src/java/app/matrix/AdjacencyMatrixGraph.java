...
public class AdjacencyMatrixGraph<V, E> implements BasicGraph<V, E>, Cloneable {
     ...
     *
     * @param x,y the position in the app.matrix
    ...
    /**
     * Resizes the app.matrix when a new vertex increases the length of ArrayList
     */
    ...
    public Iterable<V> directConnections(V vertex) {
        List<V> vertecies = new ArrayList<>();
    ...
    public boolean removeVertex(V vertex) {
        ...
        // It is necessary to collapse the edge app.matrix
